...
bool DeskDupEngine::start( bool primaryMonitorOnly )
{
	...
	{
		vWarning() << "start failed, not supported by video driver";
		return false;
	}
	...
	{
		vWarning() << "file map bitmap failed";
		return false;
	}
	...
	{
		vWarning() << "file view bitmap failed";
		return false;
	}
...
QSize DeskDupEngine::currentVirtualScreenGeometry()
{
